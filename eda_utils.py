...
from utils import date_utils, file_utils, zipcode_utils, file_processor
...
class Product_eda(Eda):
    ...
    def get_product_plot_df(df):
        ...
        product_sales_in_recent_13wks_metric['product_share'] = round((product_sales_in_recent_13ks_metric[
                                                                           PRODUCT_COL] /
...
class Store_eda(Eda):
    ...
    def get_store_plot_df(df):
        ...
        end_date = date_utils.get_date(t[WEEK_END_COL].max(), date_utils.DATE_FORMAT_ISO)
        start_date = date_utils.add_days(end_date, -12 * 7)
